...
<form enctype="multipart/form-data" id="miniSurveyView<?php  echo $bID; ?>" class="miniSurveyView" method="post" action="<?php  echo $formAction ?>">
	...
	<div class="fields">
		...
		<?php  foreach ($questions as $question): ?>					
				...
				<?php  
					...
					if($question['type']=="textarea")
						$start=10;
					$champs=substr_replace($question['input'],"class='col-md-8'",$start,0); 
					echo "<div class='col-md-3'>".$question['question']."</div>".$champs; ?>
		<?php  endforeach; ?>
	...
	<?php  endif; ?>
	<center><input type="submit" name="Submit" class="buttonreadmoreblue" value="<?php  echo $translatedSubmitLabel; ?>" /></center>
